import { NgFilesDropComponent } from './ng-files-drop.component';

describe('NgFilesDropComponent', () => {

    let sut: NgFilesDropComponent, mockChangeDetector, mockNgFilesUtilsService, mockEvent;
    ...
    beforeEach(() => {
        ...
        sut = new NgFilesDropComponent(mockChangeDetector, mockNgFilesUtilsService);
    });
